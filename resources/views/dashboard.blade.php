                ...
                <div class="bg-gray-800 rounded-xl p-4 shadow flex flex-col gap-2">
                    <div class="flex items-center justify-between mb-2">
                        <div class="flex items-center gap-3">
                            <span class="material-icons text-4xl text-{{ $bird->color }}">{{ $bird->emoji }}</span>
                            <div class="font-semibold">{{ $bird->name }}</div>
                        </div>
                        <div class="text-right">
                            <div class="font-bold text-lg">x{{ $bird->pivot->count }}</div>
...
{{--                                        <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-{{ $egg->color }} opacity-75"></span>--}}
{{--                                        <span class="relative inline-flex rounded-full h-3 w-3 bg-{{ $egg->color }}"></span>--}}
{{--                                    </span>--}}
                                    <span class="relative flex h-6 w-3 items-center justify-center" style="background-color: transparent;">
                                        <span class="material-icons text-{{ $egg->color }} text-2xl animate-blink" style="line-height: 1;">
                                            egg
                                        </span>
                                    </span>
